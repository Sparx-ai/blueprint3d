...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var Scene = (function () {
             ...
             */
            Scene.prototype.fixMaterialTextures = function (material) {
                if (!material)
                    return;
                ...
                if (material.emissiveMap) {
                    material.emissiveMap.encoding = window.THREE.sRGBEncoding;
                    material.emissiveMap.flipY = false;
                    material.emissiveMap.needsUpdate = true;
                }
                // Keep data textures (non-color) in linear encoding
                if (material.normalMap) {
                    material.normalMap.encoding = window.THREE.LinearEncoding;
                    material.normalMap.flipY = false;
                    material.normalMap.needsUpdate = true;
                }
                if (material.roughnessMap) {
                    material.roughnessMap.encoding = window.THREE.LinearEncoding;
                    material.roughnessMap.flipY = false;
                    material.roughnessMap.needsUpdate = true;
                }
                if (material.metalnessMap) {
                    material.metalnessMap.encoding = window.THREE.LinearEncoding;
                    material.metalnessMap.flipY = false;
                    material.metalnessMap.needsUpdate = true;
                }
                if (material.aoMap) {
                    material.aoMap.encoding = window.THREE.LinearEncoding;
            ...
            Scene.prototype.addItem = function (itemType, fileName, metadata, position, rotation, scale, fixed) {
                ...
                var loaderCallback = function (gltf) {
                    ...
                    if (gltf.scene) {
                        ...
                        var item = new (BP3D.Items.Factory.getClass(itemType))(scope.model, metadata, gltf.scene, // Use the loaded scene directly
                ...
                if (this.loader && this.loader.load) {
                    this.loader.load(fileName, loaderCallback, undefined, // progress callback
                    function (error) {
...
(function (BP3D) {
    ...
    (function (Floorplanner) {
        ...
        var wallColorHover = "red";
        var edgeColor = "#888888";
        var edgeColorHover = "red";
        var edgeWidth = 1;
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Edge = function (scene, edge, controls) {
            ...
            var texture = null;
            // Use TextureLoader instead of deprecated ImageUtils
            var textureLoader = new THREE.TextureLoader();
    ...
    (function (Three) {
        Three.Main = function (model, element, canvasElement, opts) {
            ...
            function init() {
                ...
                controller = new Three.Controller(scope, model, camera, elementJQ, scope.controls, hud);
                ...
                floorplan = new Three.Floorplan(sceneObj, model.floorplan, scope.controls);
                animate();
